...
**Status**: M3.1 + M3.2 + M3.2a + M3.3 complete; M3.4-M3.5 pending
**最新 val AUC**: 0.9920 (M3.2, LightGBM, 137 features); M3.3 no-lift at 0.9913
...
*Last updated: 2026-06-22 (M3.3 buds-lab alignment complete; no-lift vs M3.2)*
