...
+ Individual model val AUCs:
  ...
  + CatBoost: 0.9797 (paper 0.9857, gap 0.60%)
  + HistGBT:  0.9806 (paper 0.9839, gap 0.34%)
+ Equal-weight ensemble val AUC: **0.9830** (paper 0.9866, gap 0.36%)
+ Done when criteria:
  + ensemble ≥ 0.97 ✓
...
| M2.3 4-model ensemble | ✅ Done | 0.9830 | gap 0.36% vs paper 0.9866 |
...
+ [x] 4-model ensemble val AUC ≥ 0.97 (0.9830; gap 0.36% vs paper 0.9866)
