...
\centering
\captionof{table}{Experiment A protocol: matched-context row scarcity.}
...
Design & Scarcity variable & Labeled context rows, N \\
 & Budget levels & N=5k, 10k, 20k, 50k, 100k \\
 & Context construction & Nested stratified row samples \\
 & Class ratio & Positive:negative = 1:1 \\
 & Building coverage & 703, 724, 725, 725, 725 source buildings \\
 & Meter composition & All meter types; frequencies inherited from sampled rows \\
\addlinespace[2pt]
