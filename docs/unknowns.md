...
**狀態**: documented — M2.4 動手前 surface;M2.5 ablation candidate
...
**M2.5 ablation candidate (9th)**:

- Ablation A:移除 Rule 2a building_id filter(改 blanket Rule 2a)
- Ablation B:完全跳過 Rule 2a(只用 Rule 2b end-of-year)
- 量化各 ΔAUC,判斷 filter 重要性
