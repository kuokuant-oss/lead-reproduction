...
(confirmed)」。後來比對原作者 Kaggle profile 確認：paper 的 0.9866 ≈ Private
rounded（原作者 Private 0.9866，Public 0.9734）。早期 commits 誤算「Public gap
1.68%」，校準後 Private gap 是 0.05%（< noise floor，statistically indistinguishable）。
