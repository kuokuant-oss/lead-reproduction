...
⚠️ **Feature count 不符**: 57 原始 + 論文描述的 16 差值 + 16 比值 = 89,與 169 差距 80 個。來源不明。**論文未說明,見原始碼 buds-lab/LEAD-1st-solution。** 詳見 `docs/unknowns.md`。
...
*以下問題是重現時最可能踩坑的地方,詳細討論見 `docs/unknowns.md`。*
